...
class Wprls_Slider{
	...
	function admin_menu() {
		...
		$page_title = __( 'Slider Slideshow', 'wprls' );
		$menu_title = __( 'Slider Slideshow', 'wprls' );
    	...
    	add_submenu_page( 'wprls_sliders_page_null', 'Slider', 'Add New Slider', $capability, 'wprls_add_slider', array( $this, 'add_new_slider' ) );
